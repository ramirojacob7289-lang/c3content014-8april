...
_Hasync.push(['Histats.start', '1,5019186,4,0,0,0,00010000']);
...
<noscript><a href="/" target="_blank"><img  src="//sstatic1.histats.com/0.gif?5019186&101" alt="stats count" border="0"></a></noscript>
<!-- Histats.com  END  -->
    <meta charset="utf-8">
...
<body>
    ...
    <div id="templatemo_footer" class="container_wapper">
        <div class="container">
            <div class="row">
                <div class="col-xs-12">
                    <p>Copyright © 2084 Company Name <!-- Credit: www.templatemo.com --></p>
                </div>
            </div>
        </div>
    </div>
